...
public class straight : MonoBehaviour
{
    ...
    private void RePosition(){
            ...
            positiveSideObject.transform.localScale = new Vector3(8,4,1);
            ...
            negativeSideObject.transform.localScale = new Vector3(8,4,1);
    }
    ...
    private void Switching(){
        Vector3 sliceDirection = new Vector3(0, 1, 0);
        Vector3 saveIndexA = new Vector3(-1, 0, 0);
        Vector3 saveIndexB = new Vector3(1, 0, 0);
