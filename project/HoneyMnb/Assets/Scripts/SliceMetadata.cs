...
using UnityEngine.UIElements;
    ...
    class SlicesMetadata
    {
        ...
        public Mesh PositiveSideMesh
        {
            get
            {
                if (_positiveSideMesh == null)
                {
                    ...
                    InitializePositiveSideMesh();
                }
                
                return _positiveSideMesh;
            }
            set{ _positiveSideMesh = value;}
        }
        ...
        public Mesh NegativeSideMesh
        {
            ...
            set{ _negativeSideMesh = value;}
        }

        public SlicesMetadata(Plane plane, Mesh mesh, bool shareVertices)
        {
        ...
        public void InitializePositiveSideMesh()
        {
            SetMeshData(MeshSide.Positive);
        }
        public void InitializeNegativeSideMesh()
        {
